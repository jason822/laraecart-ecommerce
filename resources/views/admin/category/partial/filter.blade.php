<div class="btn-group ecommerce-category">
...
$(document).ready(function(){
    ...
    $(".ecommerce-category .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/ecommerce.category.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".ecommerce-category .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.ecommerce-category .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'ecommerce.category.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#ecommerce-category-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#ecommerce-category-list .btn-reset-filter').css('display', 'none');
