<div class="btn-group ecommerce-review">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[product_id]" class="col-sm-2 control-label">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[author_name]" class="col-sm-2 control-label">
                                        {!! trans('ecommerce::review.label.author_name')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[author_name]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[author_email]" class="col-sm-2 control-label">
                                        {!! trans('ecommerce::review.label.author_email')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[author_email]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[author_phone]" class="col-sm-2 control-label">
                                        {!! trans('ecommerce::review.label.author_phone')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[author_phone]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[review]" class="col-sm-2 control-label">
                                        {!! trans('ecommerce::review.label.review')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[review]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[rating]" class="col-sm-2 control-label">
                                        {!! trans('ecommerce::review.label.rating')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[rating]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
$(document).ready(function(){
    ...
    $(".ecommerce-review .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/ecommerce.review.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".ecommerce-review .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.ecommerce-review .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'ecommerce.review.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#ecommerce-review-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#ecommerce-review-list .btn-reset-filter').css('display', 'none');
