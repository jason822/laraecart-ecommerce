<div class="btn-group ecommerce-brand">
...
$(document).ready(function(){
    ...
    $(".ecommerce-brand .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/ecommerce.brand.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".ecommerce-brand .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.ecommerce-brand .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'ecommerce.brand.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#ecommerce-brand-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#ecommerce-brand-list .btn-reset-filter').css('display', 'none');
