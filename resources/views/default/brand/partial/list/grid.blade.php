                    <div class="list-view grid">
                        ...
                        <div class="col-md-4">
                        <div class="card list-view-media mb-10"  id="{!! $brand->getRouteKey() !!}">
                            <div class="card-block">
                                <div class="media">
                                    <a class="media-left" href="{!! trans_url('ecommerce') !!}/{!! $brand->getPublicKey() !!}" target="_blank">
                                        <img class="media-object card-list-img" src="http://via.placeholder.com/264x164/FC0079/FFF?text=ADVT">
                                    </a>
                                    <div class="media-body">
                                        <div class="heading">
                                            <h3><a  href="{!! trans_url('ecommerce') !!}/{!! $brand->getPublicKey() !!}" target="_blank">{{ $brand->name }}</a></h3>
                                            <h6>{{ $brand->email }}</h6>
                                            <div class="status">
                                        ...
                                        <div class="actions">
                                            ...
                                            <a href="{!! guard_url('ecommerce/brand') !!}/{!! $brand->getRouteKey() !!}" class="text-primary" data-toggle="tooltip" data-placement="left" title="Edit" data-action="EDIT" ><i class="icon-eye"></i></a>
