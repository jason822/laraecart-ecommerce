...
namespace Laraecart\Ecommerce\Http\Requests;
...
class BrandRequest extends FormRequest
{
    ...
    {
        $this->model = $this->route('brand');

        if (is_null($this->model)) {
            // Determine if the user is authorized to access brand module,
    ...
    {
        return user()->canDo('ecommerce.brand.view');
    }
}
